...
About this web app: List-based app that display content of your choosing.
...
I find challenging rendering different components using plain Vanilla JS since I used to React Routing and how easy it is to render different component while changing routes.
